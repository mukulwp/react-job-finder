...
const AddForm = () => {
  ...
  const { isError, isLoading } = useSelector((state) => state.jobs);
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <Button btnText={isLoading ? "Loading" : "Submit"} disabled={isLoading} />
      {!isLoading && isError && <div className="!text-[#FF8A00]">Something went wrong while creating job!</div>}
    </form>
  );
};
